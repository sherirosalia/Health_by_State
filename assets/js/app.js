...
svg.append("g").attr("class", "textXax");
var textXax = d3.select(".textXax");

// Transform to adjust for textXax
var TextX =  (width - labelArea)/2 + labelArea;
var TextY = height - margin - padding;
textXax.attr("transform",`translate(
    ${TextX}, 
    ${TextY})`
    );
...
//  left side 
svg.append("g").attr("class", "wrdY");
var wrdY = d3.select(".wrdY");


var leftTextX =  margin + padding;
var leftTextY = (height + labelArea) / 2 - labelArea;
wrdY.attr("transform",`translate(
    ${leftTextX}, 
     ${leftTextY}
    )rotate(-90)`
    );
